...
import DatasetFieldsFilter from "./fieldSerch";
...
const DatasetFields: React.FC = (props) => {
    ...
    return (
        <DSContainer className="p-1 sm:mr-0.5 my-0.5 border flex sm:flex-col"
            ...
            <Droppable droppableId="dimensions" direction="vertical">
                {(provided, snapshot) => (
                    <div className="flex-shrink min-w-[0px] min-h-[100px] max-h-[380px]" {...provided.droppableProps}
            ...
            <Droppable droppableId="measures" direction="vertical">
                {(provided, snapshot) => (
                    <div className="flex-shrink flex-grow min-w-[0px] min-h-[200px]" {...provided.droppableProps}
                         ref={refMapper(provided.innerRef)}>
